    ...
    <>
        ...
        <div className="container-edit relative z-10 flex min-h-[90vh] flex-col justify-center py-20">
          <Reveal>
            ...
            <div className="mt-12 flex flex-wrap gap-4">
              ...
              <Link href="/procedimentos.html" className="btn-outline !border-paper/20 !text-paper hover:!border-champagne hover:!text-champagne">
                Ver procedimentos
              </Link>
            </div>
          </Reveal>
      ...
      <section className="bg-paper py-28 dark:bg-ink">
        <div className="container-edit grid gap-16 lg:grid-cols-2 lg:items-center">
          <Reveal>
            ...
            <div className="mt-12">
              <Link href="/sobre.html" className="btn-outline">
      ...
      <section className="container-edit py-28">
        ...
        <Reveal className="mt-14">
          <Link href="/depoimentos.html" className="btn-outline">
        ...
        <div className="container-edit text-center relative overflow-hidden">
          <Reveal>
            ...
            <div className="mt-12 flex flex-wrap justify-center gap-4">
              ...
              <Link href="/contato.html" className="btn-outline !border-paper/25 !text-paper hover:!border-champagne hover:!text-champagne">
